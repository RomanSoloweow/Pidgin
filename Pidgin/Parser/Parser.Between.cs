...
namespace Pidgin
{
    public abstract partial class Parser<TContext, TToken, T>
    {
        ...
        public Parser<TContext, TToken, T> Between<U>(Parser<TContext, TToken, U> parser)
        {
            if (parser == null)
            {
        ...
        public Parser<TContext, TToken, T> Between<U, V>(Parser<TContext, TToken, U> parser1, Parser<TContext, TToken, V> parser2)
        {
            if (parser1 == null)
            {
