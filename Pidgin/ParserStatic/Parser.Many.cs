...
namespace Pidgin
{
    public static partial class Parser
    {
        ...
        public static Parser<TContext, TToken, string> ManyString<TContext, TToken>(this Parser<TContext, TToken, char> parser)
            where TContext : IParsingContext
        {
            ...
            return parser.AtLeastOnceString().Or(Parser.Return<TContext, TToken, string>(""));
        }
        ...
        public static Parser<TContext, TToken, string> ManyString<TContext, TToken>(this Parser<TContext, TToken, string> parser)
            where TContext : IParsingContext
        {
            if (parser == null)
            {
        ...
        public static Parser<TContext, TToken, string> AtLeastOnceString<TContext, TToken>(this Parser<TContext, TToken, char> parser)
            where TContext : IParsingContext
        {
            if (parser == null)
            {
        ...
        public static Parser<TContext, TToken, string> AtLeastOnceString<TContext, TToken>(this Parser<TContext, TToken, string> parser)
            where TContext : IParsingContext
        {
            if (parser == null)
            {
    ...
    {
        private static Parser<TContext, TToken, IEnumerable<T>>? _returnEmptyEnumerable;

        private static Parser<TContext, TToken, IEnumerable<T>> ReturnEmptyEnumerable
        {
            get
            {
                if (_returnEmptyEnumerable == null)
                {
                    _returnEmptyEnumerable = Parser.Return<TContext, TToken, IEnumerable<T>>(Enumerable.Empty<T>());
                }
        ...
        private static Parser<TContext, TToken, Unit>? _returnUnit;

        private static Parser<TContext, TToken, Unit> ReturnUnit
        {
            get
            {
                if (_returnUnit == null)
                {
                    _returnUnit = Parser.Return<TContext, TToken, Unit>(Unit.Value);
                }
        ...
        public Parser<TContext, TToken, IEnumerable<T>> Many()
            => AtLeastOnce()
        ...
        public Parser<TContext, TToken, IEnumerable<T>> AtLeastOnce()
        ...
        internal Parser<TContext, TToken, PooledList<T>> AtLeastOncePooled()
        ...
        /// </summary>
        /// <returns>A parser which applies the current parser zero or more times.</returns>
        public Parser<TContext, TToken, Unit> SkipMany()
            => SkipAtLeastOnce()
                .Or(ReturnUnit);
        ...
        public Parser<TContext, TToken, Unit> SkipAtLeastOnce()
